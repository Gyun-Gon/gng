  ...
  <body>
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div id="board-content-container" class="col-lg-8 col-md-10 col-sm-12">
          <div class="row my-2">
            <h2 id="boardIdTitle" class="text-secondary px-5" board-id="${board.boardId}">${board.boardId}. ${board.title}</h2>
          </div>
          <div class="row">
            <div class="col-md-8">
